...
Exemplo: retornar somente os empregos com departamento associado*/
SELECT empregados.emp_id, empregados.nome AS empregado,
departamentos.nome AS departamento 
FROM empregados
INNER JOIN departamentos 
ON empregados.depto_id = departamentos.depto_id;
/*Estrutura: SELECT tabela1_coluna1, tabela1_coluna2.....alter
FROM tabela1
INNER JOIN tabela2 ON tabela1.id = tabela2.id*/

/*LEFT JOIN 
Listar todos os clientes e seu pedidos, mostrando NULL para clientes que não
tenham pedidos*/
...
/*RIGHT JOIN
Listar todos os pedidos e os clientes correspondentes, incluindo
pedidos com cliente ausente*/
SELECT pedidos.pedido_id, pedidos.valor, clientes.nome AS cliente
FROM clientes  
