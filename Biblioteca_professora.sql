...
/*MOSTRE NOME DO LIVRO, E DATA DE PUBLICACAO*/
...
/*Livros com preoço maior que 30 reais*/
SELECT * FROM tbl_livro WHERE preco_livro > 30; 

/*ordenar os livros do menor para o amior*/
...
SELECT *
FROM tbl_livro WHERE preco_livro > 20 
ORDER BY preco_livro ASC LIMIT 3;
